          ...
          <div class="card-body">
            <form action="<?= base_url('dashboard/matakuliah'); ?>" method="POST">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control <?= session('validation') && session('validation')->hasError('kode_mata_kuliah') ? 'is-invalid' : ''; ?>" id="kode_mata_kuliah" name="kode_mata_kuliah" value="<?= old('kode_mata_kuliah'); ?>">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control <?= session('validation') && session('validation')->hasError('nama_mata_kuliah') ? 'is-invalid' : ''; ?>" id="nama_mata_kuliah" name="nama_mata_kuliah" value="<?= old('nama_mata_kuliah'); ?>">
                <?php if (session('validation')) : ?>
                  <div class="invalid-feedback">
